...
export function MathButtons() {
  ...
  return (
    <>
      <Button {...Types.BUTTONS.SQUARE_ROOT} col={4} row={4} />

      <Button {...Types.BUTTONS.ADD} col={4} row={5} />
      <Button {...Types.BUTTONS.SUBTRACT} col={4} row={6} />

      <Button {...Types.BUTTONS.MULTIPLY} col={4} row={7} />
      <Button {...Types.BUTTONS.DIVIDE} col={4} row={8} />
    </>
  );
}
